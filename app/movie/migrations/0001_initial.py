    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_use', models.PositiveSmallIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Сборы в США')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movie.Actor', verbose_name='Режжиссер')),
                ('genres', models.ManyToManyField(related_name='film_genre', to='movie.Genre', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
