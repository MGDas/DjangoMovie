...
class Actor(models.Model):
    ...
    class Meta:
        verbose_name = "Актеры и режжиссеры"
        verbose_name_plural= "Актеры и режжиссеры"
...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(
        Actor, verbose_name="Режжиссер", related_name="film_director"
    )
...
class MovieShot(models.Model):
    ...
    movie = models.ForeignKey(
        Movie, verbose_name="Фильм", on_delete=models.CASCADE, related_name='shots'
    )
